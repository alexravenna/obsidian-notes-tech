...
- Basically, high-end [[GPU]]s in the [[Microsoft Azure/Azure]] cloud are used to render models at a higher fidelity than possible on a device such as the HoloLens
